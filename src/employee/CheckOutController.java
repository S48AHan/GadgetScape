...
public class CheckOutController implements Initializable {
    ...
    private void submitBtnAction(ActionEvent event) throws ClassNotFoundException, SQLException {
        ...
        if (customerNameText.getText().isEmpty()) {
            ...
            errorAlert.setHeaderText("No Customer");
            errorAlert.setContentText("Please Choose A Customer");
            ...
            availablePoint = availablePoint + rewardPoints;

            String updateCustomerPoints = "UPDATE Customer set Points=" + availablePoint + "where Cus_ID='" + choosenCustomerID + "'";
            ...
            for (int i = 0; i < cartItemsContainer.size(); i++) {
                ...
                System.out.println(insertIntoPerTrans);
                ...
                String updateQuantity = "UPDATE Products set Quantity=" + newQuantity + "where Product_ID=" + id;
        ...
        if (customerNameText.getText().isEmpty()) {
            ...
            if (discountRB.isSelected()) {
                ...
                if (currentPoint > 0) {
                    ...
                    float discountAmount = (float) ((float) currentPoint * 0.01);  //per 100 point = 1 taka 1000
